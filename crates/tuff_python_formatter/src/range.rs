...
pub fn format_range(
    ...
    let mut custom_layout = custom::layout::build_layout_plan(
        parsed.syntax().into(),
        parsed.tokens(),
        &comments,
        source_code,
    ...
    custom::layout::restrict_to_range(&mut custom_layout, narrowed_range);
    context = context.with_custom_layout(custom_layout);
