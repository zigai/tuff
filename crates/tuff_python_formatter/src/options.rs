...
pub struct PyFormatOptions {
    ...
    /// Tuff-specific formatting options. These describe user intent only; computed
    /// per-file decisions belong in the custom layout plan.
    #[cfg_attr(feature = "serde", serde(default))]
    custom: TuffCustomOptions,
}
...
impl Default for PyFormatOptions {
    fn default() -> Self {
        Self {
            ...
            custom: TuffCustomOptions::default(),
        }
    }
}
...
impl PyFormatOptions {
    ...
    pub const fn custom(&self) -> &TuffCustomOptions {
        &self.custom
    }
    ...
    #[must_use]
    pub fn with_custom(mut self, custom: TuffCustomOptions) -> Self {
        self.custom = custom;
        self
    }
}
