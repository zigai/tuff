...
use crate::custom::layout::TuffLayoutPlan;
use crate::custom::options::TuffCustomOptions;
...
impl<'a> PyFormatContext<'a> {
    pub(crate) fn new(
        ...
        Self {
            ...
            trivia,
            tokens,
            custom_layout: TuffLayoutPlan::default(),
    ...
    pub(crate) fn new_for_testing(
        ...
        Self::new(options, contents, comments, trivia, tokens)
    }
    ...
    pub fn custom_layout(&self) -> &TuffLayoutPlan {
        &self.custom_layout
    }

    pub(crate) fn with_custom_layout(mut self, custom_layout: TuffLayoutPlan) -> Self {
        self.custom_layout = custom_layout;
        self
    }

    pub fn custom_options(&self) -> &TuffCustomOptions {
        self.options.custom()
    }
